    ...
    <div class="container">
        <div class="row">
            <div class="jumbotron" style="background-color: rgb(243, 243, 229);">
                ...
                <p>
                    <strong>Célom</strong>, hogy a nyugati gyógyítás és az alternatív módszerek együttes alkalmazásával segíthessek.
                </p>
                <img src="{{ asset('assets/image/myself.jpg')}}" alt="" class="img-responsive">
            </div>
        </div>
    </div>
@stop