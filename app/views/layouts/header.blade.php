<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/main.css?rand=').rand(0,100) }}">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/reset.css?rand=').rand(0,100) }}">
