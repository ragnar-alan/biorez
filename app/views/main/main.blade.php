...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>
                    Biorezonanciás állapotfelmérés - személyre szabott tanácsadás - kezelés!
                </h1>
